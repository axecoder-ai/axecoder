...
- `claude-code/docs/claude-code-system-prompts-full.md` — §14 工具级系统提示索引
- `docs/research/research-claude-code.md` — 工具装配与 `prompt.ts` 约定
...
**调研缺口：** 本地 `claude-code` 无 `src/tools/*/prompt.ts` 源码快照；§14 以文档索引 + AxeCoder 已实现能力为准撰写长描述，不声称逐字节 1:1。
