...
- `claude-code/docs/claude-code-system-prompts-full.md` — §11 动态段、§15 组装顺序
- `claude-code/src/constants/prompts.ts` — `SYSTEM_PROMPT_DYNAMIC_BOUNDARY`、`dynamicSections`、`computeSimpleEnvInfo`、`getLanguageSection`
